...
> **来源**: <https://dev.epicgames.com/documentation/en-us/fortnite/build-your-own-lego-obstacle-course-in-fortnite-creative>
> **爬取时间**: 2025-12-27T00:37:14.788352
...
The Obstacle Course, or [obby](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-creative-glossary#obby) template, teaches you how to take basic Fortnite gameplay ideas and use them in the [LEGO® Minifigure](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-creative-glossary#minifigure) world. You can use what you learn in this template to make your own version of the game, or build something totally new!

[![Welcome to Obby!](https://dev.epicgames.com/community/api/documentation/image/58660937-adb7-4ace-8ec3-ff2fef1fee86?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/58660937-adb7-4ace-8ec3-ff2fef1fee86?resizing_type=fit)

There are slight differences from Fortnite; some devices are unavailable and some building settings are hidden. Players can't mantle, vault, crouch, or slide as a Minifigure, so jumping becomes much more important for players. To learn more, refer to **[Working with LEGO® Islands](https://dev.epicgames.com/documentation/en-us/fortnite/working-with-lego-islands-in-fortnite-creative)**.
...
[![The First Set of Jumps](https://dev.epicgames.com/community/api/documentation/image/ed9521c7-e45e-4595-8da2-2863488854dc?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/ed9521c7-e45e-4595-8da2-2863488854dc?resizing_type=fit)

After players learn a [mechanic](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-creative-glossary#game-mechanics), you can follow up with a variation, such as harder jumps, jumps on moving platforms, or jumps on a time limit. For example, this template starts with simple jumps, then introduces moving platforms.
...
[![Gameplay Progression of Jumps](https://dev.epicgames.com/community/api/documentation/image/66a041a5-0caa-45c7-98c8-21844c3126ee?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/66a041a5-0caa-45c7-98c8-21844c3126ee?resizing_type=fit)
...
[![Collectibles encourage your players to explore.](https://dev.epicgames.com/community/api/documentation/image/d8444aed-1b87-4e8b-bb1f-4a88dbe032b3?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/d8444aed-1b87-4e8b-bb1f-4a88dbe032b3?resizing_type=fit)
...
You can place collectibles that are worth more in difficult areas, or make some collectibles run on a timer and disappear if players don't reach them fast enough. You can also pair collectibles with other mechanics like items and [powerups](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-creative-glossary#powerup) so that players need to bring the right tools for the job if they want to maximize their score. For instance, a player may need to grab a grappler to reach a coin up high or grab a health powerup to survive a run across spikes. Experiment with different placements and ideas and see what works best for your game!
...
[![Collectibles on Lava](https://dev.epicgames.com/community/api/documentation/image/8e86f50a-74b7-4732-8a14-b9e669043235?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/8e86f50a-74b7-4732-8a14-b9e669043235?resizing_type=fit)
...
Now that you've learned the basic ideas of creating your own obby, get out there and get building! To learn the basics of creating on a LEGO Island, check out the [LEGO Home Builder Template](https://dev.epicgames.com/documentation/en-us/fortnite/build-lego-home-builder-in-fortnite)!
