...
If you're going to build your own LEGO Island, you will need to be familiar with the [LEGO® Brand and Creator Rules](https://dev.epicgames.com/documentation/en-us/fortnite/lego-brand-and-creator-rules-in-fortnite-creative#rules-for-using-lego-templates). Take a minute and read through these. You will also need to sign the agreement via the Creator Portal.
...
- **LEGO® Minifigure**: The player character that shows when building or playing a LEGO Island in Fortnite. Minifigures are half the size of the usual Fortnite character, so everything on a LEGO Island is scaled down to half size to match. Half the size but twice the cute!
...
If you are not sure which template to start with, explore the [LEGO Templates](https://dev.epicgames.com/documentation/en-us/fortnite/lego-templates-in-fortnite) page for an overview of all available starter and learning templates.
...
1. Click **Create New**, then select the **LEGO® Templates** tab and you can see the LEGO Island templates available. Pick one!

   [![LEGO Island templates](https://dev.epicgames.com/community/api/documentation/image/892dd67b-4f0b-4cfb-8428-463fe0a5e493?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/892dd67b-4f0b-4cfb-8428-463fe0a5e493?resizing_type=fit)
2. Choose the island template you want to use, then click **Confirm**. If you need more info, see [Let's Play!](https://dev.epicgames.com/documentation/en-us/fortnite/lets-play-in-fortnite-creative)
3. Name your island and click **Confirm**, and there you go! The island you created will always appear in the list of islands you created.
...
1. Click **Brand Islands** from the template list on the left, and select a template from the **LEGO® Islands** section. In the image below, you can see the **Scary Space** template is selected.

   [![Select the Scary Space template in the Project Browser.](https://dev.epicgames.com/community/api/documentation/image/08080de3-eb54-4231-931a-92faae0e7d90?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/08080de3-eb54-4231-931a-92faae0e7d90?resizing_type=fit)
2. Select the location and name your project.
