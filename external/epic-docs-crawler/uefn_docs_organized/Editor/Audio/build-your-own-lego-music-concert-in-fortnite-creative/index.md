...
Welcome to the **LEGO® Music Concert island**, where players can learn about about the [Fortnite Patchwork music system](https://dev.epicgames.com/documentation/en-us/fortnite/composing-with-patchwork-in-fortnite-creative) in a desert playground. Players can experiment with the devices and even make their own music!

The LEGO templates are slightly different from Fortnite Creative islands: some devices are not available to use, and some settings are hidden. To learn more, see [Working with LEGO® Islands](https://dev.epicgames.com/documentation/en-us/fortnite/working-with-lego-islands-in-fortnite-creative).
...
You can see that the **Beacon** device is used here to guide the player through a [golden path](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-creative-glossary#golden-path). This is useful when you are learning something step by step or layer by layer. The player is free to explore, but the beacons provide structure and let them know what they should do next when they're ready to move forward.

[![Vulture Dialog - Welcome](https://dev.epicgames.com/community/api/documentation/image/24a19ebf-8856-46ef-9d6d-dc7fdb56bcd6?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/24a19ebf-8856-46ef-9d6d-dc7fdb56bcd6?resizing_type=fit)
...
[![Beacon 2 Displayed](https://dev.epicgames.com/community/api/documentation/image/6dbb3fbf-afc3-4b53-a09a-39622cc60441?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/6dbb3fbf-afc3-4b53-a09a-39622cc60441?resizing_type=fit)
...
[![DJ Llama Dialog](https://dev.epicgames.com/community/api/documentation/image/9b270f9b-02ff-4c54-909f-6e9523e6c72e?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/9b270f9b-02ff-4c54-909f-6e9523e6c72e?resizing_type=fit)
...
[![DJ Llama's Sign](https://dev.epicgames.com/community/api/documentation/image/7ceca8f3-c47a-4738-85ea-667b1218e43e?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/7ceca8f3-c47a-4738-85ea-667b1218e43e?resizing_type=fit)
...
![Drum Sequencer Original Settings](https://dev.epicgames.com/community/api/documentation/image/74417dad-7c63-4a48-9cdf-1d24afb58a89?resizing_type=fit&width=1920&height=1080)

![Drum Sequencer with Edited Settings](https://dev.epicgames.com/community/api/documentation/image/6299b545-8a83-4a8f-8145-f64e5d35f50d?resizing_type=fit&width=1920&height=1080)

Drum Sequencer Original Settings

Drum Sequencer with Edited Settings
...
[![Piano Rabbit's Dialog](https://dev.epicgames.com/community/api/documentation/image/caa5e25e-0110-4639-8907-0350e1bab5a1?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/caa5e25e-0110-4639-8907-0350e1bab5a1?resizing_type=fit)
...
[![Piano Rabbit's Sign](https://dev.epicgames.com/community/api/documentation/image/47cec8eb-df80-4df1-864f-b54312d08e1d?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/47cec8eb-df80-4df1-864f-b54312d08e1d?resizing_type=fit)
...
![Note Sequencer with Original Settings](https://dev.epicgames.com/community/api/documentation/image/3cb71f34-16b2-4fda-8a9b-edb870ef721b?resizing_type=fit&width=1920&height=1080)

![Note Sequencer with Edited Settings](https://dev.epicgames.com/community/api/documentation/image/59f7aca9-53fc-4b9c-b291-d3217dc78d63?resizing_type=fit&width=1920&height=1080)

Note Sequencer with Original Settings

Note Sequencer with Edited Settings
...
[![Organ Frog's Dialog](https://dev.epicgames.com/community/api/documentation/image/bec36d4b-8d88-4e34-a84e-823f512c69ff?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/bec36d4b-8d88-4e34-a84e-823f512c69ff?resizing_type=fit)
...
[![Instrument Player Changing Instrument](https://dev.epicgames.com/community/api/documentation/image/668f2bbb-ec08-4f46-a549-b22a111f63e2?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/668f2bbb-ec08-4f46-a549-b22a111f63e2?resizing_type=fit)
...
[![Vibe Turtle's Dialog](https://dev.epicgames.com/community/api/documentation/image/a7fb38f8-5de8-4fd4-ad6c-bd999c324abe?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/a7fb38f8-5de8-4fd4-ad6c-bd999c324abe?resizing_type=fit)
...
[![Organ Frog's Sign](https://dev.epicgames.com/community/api/documentation/image/c34de39a-def3-420b-8fed-bb09ad847e07?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/c34de39a-def3-420b-8fed-bb09ad847e07?resizing_type=fit)
...
- [Add more of the Patchwork devices](https://dev.epicgames.com/documentation/en-us/fortnite/using-patchwork-devices-in-fortnite-creative), and lead players through the composition of a larger or more complex musical piece.
...
Although you can't use [all the devices](https://dev.epicgames.com/documentation/en-us/fortnite/using-devices-in-fortnite) in the Creative toolset, there are almost 100 devices that are approved for you to use on your LEGO Island. You can add devices to enhance the existing gameplay, or even completely change it!
...
- Add [Prop Mover](https://dev.epicgames.com/documentation/en-us/fortnite/using-prop-mover-devices-in-fortnite-creative) devices (along with the Patchwork [Note Trigger](https://dev.epicgames.com/documentation/en-us/fortnite/using-patchwork-note-trigger-devices-in-fortnite-creative) device) to create objects that move to the music. You can create a platforming component to the music learning path! Want to learn more? Check out this defunct disco where we show you how to build this experience in [Syncing Music and Gameplay Using Fortnite Patchwork](https://www.youtube.com/watch?v=Ne5TKWYi25M).
...
- You could create an area on the festival grounds for mini-games, and add another Beacon device to lead players there after they have completed the main learning path. Think about carnival games, or other games that include music, and find the [devices](https://dev.epicgames.com/documentation/en-us/fortnite/lego-asset-inventory-in-fortnite-creative#devices) you need to make those mini-games happen!
...
Want to learn more about Fortnite Patchwork? Learn how to experiment with Patchwork devices by checking out the [Patchwork Music Gallery](https://www.fortnite.com/@harmonixlabs/5806-7083-7937) and [Club Patchwork](https://www.fortnite.com/@harmonixlabs/6730-0905-0185) islands, and the [Composing with Fortnite Patchwork](https://dev.epicgames.com/documentation/en-us/fortnite/composing-with-patchwork-in-fortnite-creative) section of our Creative documentation.

To learn the basics of creating on a LEGO Island, check out the [LEGO Home Builder Template](https://dev.epicgames.com/documentation/en-us/fortnite/build-lego-home-builder-in-fortnite)!
