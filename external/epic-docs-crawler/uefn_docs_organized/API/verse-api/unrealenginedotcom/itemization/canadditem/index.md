...
`(Inventory:inventory_component).CanAddItem<public><native>(Item:entity, AllowMergeItems:logic)<transacts>:`[`result(success_type,error_type)`](/documentation/en-us/fortnite/verse-api/versedotorg/verse/result/result(success_type,error_type))
