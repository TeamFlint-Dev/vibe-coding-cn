...
`(Item:item_component).CanUnequip<public><native>()<transacts>:`[`result(success_type,error_type)`](/documentation/en-us/fortnite/verse-api/versedotorg/verse/result/result(success_type,error_type))
