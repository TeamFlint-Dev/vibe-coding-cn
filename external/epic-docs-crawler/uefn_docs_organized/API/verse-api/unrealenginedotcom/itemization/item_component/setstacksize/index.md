...
`SetStackSize<public><final><native>(NewStackSize:int)<transacts>:void`

## Parameters

`SetStackSize` takes the following parameters:
...
The following specifiers determine how you can interact with `SetStackSize` in your programs. For the complete list of specifiers, see the [Specifiers Page](/documentation/en-us/fortnite/specifiers-and-attributes-in-verse).
...
The following effects determine how `SetStackSize` behaves in your programs. For the complete list of effects, see the Effect Specifers section of the [Specifiers Page](/documentation/en-us/fortnite/specifiers-and-attributes-in-verse).
