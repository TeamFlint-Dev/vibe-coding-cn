...
`(InitialRotation:rotation).ApplyWorldRotationZ<public><native>(AngleRadians:float)<transacts>:`[`rotation`](/documentation/en-us/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/rotation)
