...
`(InEntity:entity).GetPlayspaceForEntity<public><native>()<transacts><decides>:`[`fort_playspace`](/documentation/en-us/fortnite/verse-api/fortnitedotcom/playspaces/fort_playspace)
