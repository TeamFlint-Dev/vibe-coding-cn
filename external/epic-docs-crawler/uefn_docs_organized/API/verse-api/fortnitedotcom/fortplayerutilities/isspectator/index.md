# (InAgent:agent).IsSpectator extension

> **来源**: <https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/isspectator>
> **爬取时间**: 2025-12-27T00:59:58.751764
...
`(InAgent:agent).IsSpectator<public><native>()<transacts><decides>:void`

## Parameters

`IsSpectator` takes the following parameters:
