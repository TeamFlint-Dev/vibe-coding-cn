...
> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/characters/fort_character/getlinearvelocity
> **爬取时间**: 2025-12-27T05:07:07.594197

---

Returns a ‘fort\_character’s linear velocity in meters/second.

|  |  |
| --- | --- |
| Verse `using` statement | `using { /Fortnite.com/Characters }` |

`GetLinearVelocity<public>()<reads><computes>:`[`vector3`](/documentation/en-us/fortnite/verse-api/versedotorg/spatialmath/vector3)
