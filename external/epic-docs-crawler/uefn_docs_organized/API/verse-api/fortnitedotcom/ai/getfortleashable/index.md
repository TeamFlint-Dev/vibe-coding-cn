...
Get the current fort\_leashable interface for the specified character.

|  |  |
| --- | --- |
| Verse `using` statement | `using { /Fortnite.com/AI }` |

`(InCharacter:fort_character).GetFortLeashable<public>()<transacts><decides>:`[`fort_leashable`](/documentation/en-us/fortnite/verse-api/fortnitedotcom/ai/fort_leashable)
