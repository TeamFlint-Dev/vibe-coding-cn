...
> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/ui/slider_regular/getvalue
> **爬取时间**: 2025-12-27T02:57:06.352954
...
`GetValue<public><native>()<transacts><no_rollback>:float`

## Parameters

`GetValue` does not take any parameters.
