...
> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/perception_trigger_device
> **爬取时间**: 2025-12-27T01:40:58.781806
...
| [`GetLookingAtDeviceAgents`](/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/perception_trigger_device/getlookingatdeviceagents) | Returns an array of agents that are currently of the class defined by this device. |
...
| [`GetPerceivedAgents`](/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/perception_trigger_device/getperceivedagents) | Returns an array of agents that are currently of the class defined by this device. |
...
| [`IsLookingAtDevice`](/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/perception_trigger_device/islookingatdevice) | Succeeds when `Agent` is registered to this checkpoint. |
| [`IsPerceived`](/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/perception_trigger_device/isperceived) | Succeeds when `Agent` is registered to this checkpoint. |
