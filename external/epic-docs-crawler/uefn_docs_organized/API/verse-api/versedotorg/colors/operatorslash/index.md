...
> **来源**: <https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/colors/operatorslash>
> **爬取时间**: 2025-12-27T01:19:16.586225
...
`operator'/'<public><native>(c:color, factor:float)<decides>:`[`color`](/documentation/en-us/fortnite/verse-api/versedotorg/colors/color)
