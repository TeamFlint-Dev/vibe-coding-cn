...
`(Session:session).Environment<public><native>()<transacts>:`[`session_environment`](/documentation/en-us/fortnite/verse-api/versedotorg/simulation/session_environment)
