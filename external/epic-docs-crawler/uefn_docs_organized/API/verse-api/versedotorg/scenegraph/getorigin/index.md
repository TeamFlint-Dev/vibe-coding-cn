...
Returns the origin of the entity in any, in the case the entity does not have a transform\_component the method will fail

|  |  |
| --- | --- |
| Verse `using` statement | `using { /Verse.org/SceneGraph }` |

`(InEntity:entity).GetOrigin<public><native>()<transacts><decides>:`[`origin`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/origin)

## Parameters

`GetOrigin` takes the following parameters:
