...
> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/findsweephits-1
> **爬取时间**: 2025-12-27T00:52:03.831585

---

Find objects in the scene that would intersect this entity if it were swept from GlobalTransform along the Displacement vector. Returns the first object interacting as collision\_interaction.Block, and all objects interacting as collision\_interaction.Overlap encountered before the first block. Hits are sorted by hit distance, so the blocking hit will be last.

|  |  |
| --- | --- |
| Verse `using` statement | `using { /Verse.org/SceneGraph }` |

`(Entity:entity).FindSweepHits<public>(Displacement:vector3, StartGlobalTransform:transform)<transacts>:generator(sweep_hit)`
