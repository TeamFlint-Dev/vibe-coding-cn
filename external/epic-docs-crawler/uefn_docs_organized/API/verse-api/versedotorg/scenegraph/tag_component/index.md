...
> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/tag_component
> **爬取时间**: 2025-12-27T00:53:23.826309
...
| Name | Description |
| --- | --- |
| [`tag_view`](/documentation/en-us/fortnite/verse-api/versedotorg/simulation/tags/tag_view) | A queryable collection of gameplay tags. |
...
| --- | --- |
| [`AddTag`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/tag_component/addtag) | Adds a tag to this component. Returns `true` if the tag was not present before being added. |
| [`Has`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/tag_component/has) | Determine if TagToCheck is present in this container, also checking against parent tags {"A.1"}.Has("A") will return True, {"A"}.Has("A.1") will return False If TagToCheck is not Valid it will always return False. |
| [`HasAll`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/tag_component/hasall) | Checks if this container contains ALL of the tags in the specified container, also checks against parent tags {"A.1","B.1"}.HasAll({"A","B"}) will return True, {"A","B"}.HasAll({"A.1","B.1"}) will return False If InTags is empty/invalid it will always return True, because there were no failed checks. |
| [`HasAny`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/tag_component/hasany) | Checks if this container contains ANY of the tags in the specified container, also checks against parent tags {"A.1"}.HasAny({"A","B"}) will return True, {"A"}.HasAny({"A.1","B"}) will return False If InTags is empty/invalid it will always return False. |
...
| [`RemoveTag`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/tag_component/removetag) | Removes a tag from this component. Returns `true` if the tag was present before being removed. |
