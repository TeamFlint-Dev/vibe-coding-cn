# (InEntity:entity).FindAncestorEntitiesWithComponent extension

> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/findancestorentitieswithcomponent
> **爬取时间**: 2025-12-27T00:55:28.242905
...
`FindAncestorEntitiesWithComponent` takes the following parameters:
...
The following attributes, specifiers, and effects determine how you can interact with `FindAncestorEntitiesWithComponent` in your programs, as well as how it behaves in your programs and UEFN. For the complete list of attributes, specifiers, and effects; see the [Specifiers Page](/documentation/en-us/fortnite/specifiers-and-attributes-in-verse).
