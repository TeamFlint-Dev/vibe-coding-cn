# keyframed_movement_component class

> **来源**: <https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/keyframedmovement/keyframed_movement_component>
> **爬取时间**: 2025-12-27T02:45:29.805783

---

Provides teleportation and simple keyframe-based animation for an entity. Animations play back in the Pre-Physics tick phase. When animating an entity with a parent\_constraint, animation will be relative to the parent entity.
...
| --- | --- |
| [`HasValidAnimation`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/keyframedmovement/keyframed_movement_component/hasvalidanimation) | Is there a valid set of playable keyframes? |
...
| [`IsPaused`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/keyframedmovement/keyframed_movement_component/ispaused) | Is the animation paused? |
| [`IsPlaying`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/keyframedmovement/keyframed_movement_component/isplaying) | Is the animation currently playing? |
...
| [`Pause`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/keyframedmovement/keyframed_movement_component/pause) | Pause movement. Subsequently calling Play() will resume from the point in the animation when it was paused. |
| [`Play`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/keyframedmovement/keyframed_movement_component/play) | Begin or resume playback. |
...
| [`SetKeyframes`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/keyframedmovement/keyframed_movement_component/setkeyframes) | Stop any ongoing animation, sets the animation path and rebases it relative to the actor's current transform. Does not start playing until you call Play(). |
| [`Stop`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/keyframedmovement/keyframed_movement_component/stop) | Stop and reset transform to the initial state. Subsequently calling Play() will begin the animation anew. |
| [`Stop`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/keyframedmovement/keyframed_movement_component/stop-1) | Stop and reset transform to the initial state. Subsequently calling Play() will begin the animation anew. |
