...
| `GlobalTransform` | `?transform` | Current transform of the entity, globally referenced. Any value set at construction will be overrridden with the calculation from the Local Transform |
| `LocalTransform` | `?transform` | LocalTransform to its parent/origin |
| `Origin` | `??origin` | alternate origin than the default parent entity |
