...
> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/component/isinscene
> **爬取时间**: 2025-12-27T02:41:39.654868
...
`IsInScene<public><native><final>()<reads><computes><decides>:void`
...
The following specifiers determine how you can interact with `IsInScene` in your programs. For the complete list of specifiers, see the [Specifiers Page](/documentation/en-us/fortnite/specifiers-and-attributes-in-verse).
...
The following effects determine how `IsInScene` behaves in your programs. For the complete list of effects, see the Effect Specifers section of the [Specifiers Page](/documentation/en-us/fortnite/specifiers-and-attributes-in-verse).
