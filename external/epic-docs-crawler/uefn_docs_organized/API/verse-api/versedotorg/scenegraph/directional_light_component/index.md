# directional_light_component class

> **来源**: <https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/directional_light_component>
> **爬取时间**: 2025-12-27T00:50:32.269974
...
| `Illuminance` | `?float` | Intensity of the light hitting the surface. In Lux (Lumen per square meter). |
| `SourceAngleDegrees` | `?float` | Angle subtended by light source in degrees (also known as angular diameter). Defaults to 0.5357 which is the angle for our sun. |
