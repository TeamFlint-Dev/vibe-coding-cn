...
Campaigns are featured in the Sponsored Row, a clearly labeled row for promoted islands in Discover.

You can create a campaign and manage it from the Creator Portal, where you measure their effectiveness.

To learn more about **Sponsored Row** and **campaigns**, see the documentation below:

[![Sponsored Campaigns Overview](https://dev.epicgames.com/community/api/documentation/image/e3f7bd14-bae1-4a74-bc17-76579d5f5fc9?resizing_type=fit&width=640&height=640)
