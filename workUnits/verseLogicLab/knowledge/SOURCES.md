...
| **Option in Verse** | 官方文档（本地） | `external/epic-docs-crawler/uefn_docs_organized/Verse-Language/option-in-verse/index.md` | option[T] 类型定义、构造、访问、persistable 特性 | 2026-01-12 |
