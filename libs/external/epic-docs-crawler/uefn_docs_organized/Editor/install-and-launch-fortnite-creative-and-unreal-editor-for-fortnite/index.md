...
[![](https://dev.epicgames.com/community/api/documentation/image/18adea91-3005-4f4b-8a69-354e44d169d2?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/18adea91-3005-4f4b-8a69-354e44d169d2?resizing_type=fit)
...
1. From the launcher, go to **Library**.
2. Use the search window to search for **Fortnite**.
3. Click the tile to launch it.

Once you've launched it the first time, you will be able to launch it from the **Quick Launch** menu.

[![](https://dev.epicgames.com/community/api/documentation/image/f0173c3c-3fcb-4c6a-8084-6f80f82b40a3?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/f0173c3c-3fcb-4c6a-8084-6f80f82b40a3?resizing_type=fit)
...
[![](https://dev.epicgames.com/community/api/documentation/image/df9730fc-6e48-43a8-ad33-6877becdd9c5?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/df9730fc-6e48-43a8-ad33-6877becdd9c5?resizing_type=fit)

1. If you don't see the Creative tile on this page, you can search for it.

[![](https://dev.epicgames.com/community/api/documentation/image/d825849a-e45c-42bf-9008-25b34fe1f278?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/d825849a-e45c-42bf-9008-25b34fe1f278?resizing_type=fit)

1. Click **Creative**, then click **Select**. This takes you to the **Creative hub**.
2. Use the **golden rift** to enter Creative.
...
1. Search for **Unreal Editor for Fortnite**.
2. Click **Download**.
3. Follow the steps when prompted.
4. Once UEFN is downloaded and installed, navigate back to your **Library** and select **Unreal Engine for Fortnite** to launch it.
