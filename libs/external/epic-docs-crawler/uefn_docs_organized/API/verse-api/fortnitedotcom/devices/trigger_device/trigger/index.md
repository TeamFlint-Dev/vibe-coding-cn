...
> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/trigger_device/trigger
> **爬取时间**: 2025-12-27T06:28:52.601788
...
`Trigger<public>(Agent:agent)<transacts><no_rollback>:void`

## Parameters

`Trigger` takes the following parameters:
