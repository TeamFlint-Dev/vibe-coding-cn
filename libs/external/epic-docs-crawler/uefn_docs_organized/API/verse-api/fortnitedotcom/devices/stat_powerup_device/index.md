# stat_powerup_device class

> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/stat_powerup_device
> **爬取时间**: 2025-12-27T01:45:34.062781
...
| [`GetMagnitude`](/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/stat_powerup_device/getmagnitude) | Returns the current *Magnitude* for the powerup. For the Stat Powerup, this is the value of the stat that the powerup will add or remove to a player that picks up the powerup. |
