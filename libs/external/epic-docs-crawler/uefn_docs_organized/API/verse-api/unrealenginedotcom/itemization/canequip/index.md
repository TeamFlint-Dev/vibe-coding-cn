...
> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/unrealenginedotcom/itemization/canequip
> **爬取时间**: 2025-12-27T01:02:46.648234
...
`(Item:item_component).CanEquip<public><native>()<transacts>:`[`result(success_type,error_type)`](/documentation/en-us/fortnite/verse-api/versedotorg/verse/result/result(success_type,error_type))
