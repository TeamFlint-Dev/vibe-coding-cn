...
| --- | --- |
| [`AddWidget`](/documentation/en-us/fortnite/verse-api/unrealenginedotcom/temporary/ui/canvas/addwidget) | Adds a new child slot to the canvas. |
...
| [`RemoveWidget`](/documentation/en-us/fortnite/verse-api/unrealenginedotcom/temporary/ui/canvas/removewidget) | Removes a slot containing the given widget. |
