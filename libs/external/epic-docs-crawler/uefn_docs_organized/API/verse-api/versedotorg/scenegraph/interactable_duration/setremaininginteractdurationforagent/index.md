...
`SetRemainingInteractDurationForAgent<public><final><native>(Agent:agent, RemainingDuration:float)<transacts>:void`

## Parameters

`SetRemainingInteractDurationForAgent` takes the following parameters:
...
The following specifiers determine how you can interact with `SetRemainingInteractDurationForAgent` in your programs. For the complete list of specifiers, see the [Specifiers Page](/documentation/en-us/fortnite/specifiers-and-attributes-in-verse).
...
The following effects determine how `SetRemainingInteractDurationForAgent` behaves in your programs. For the complete list of effects, see the Effect Specifers section of the [Specifiers Page](/documentation/en-us/fortnite/specifiers-and-attributes-in-verse).
