# (InEntity:entity).FindAncestorComponents extension

> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/findancestorcomponents
> **爬取时间**: 2025-12-27T00:50:42.419706
...
`(InEntity:entity).FindAncestorComponents<public><native>(component_type:castable_subtype(component))<transacts>:generator()`

## Parameters

`FindAncestorComponents` takes the following parameters:
...
The following attributes, specifiers, and effects determine how you can interact with `FindAncestorComponents` in your programs, as well as how it behaves in your programs and UEFN. For the complete list of attributes, specifiers, and effects; see the [Specifiers Page](/documentation/en-us/fortnite/specifiers-and-attributes-in-verse).
