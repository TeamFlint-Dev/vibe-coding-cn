# particle_system_component class

> **来源**: https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/particle_system_component
> **爬取时间**: 2025-12-27T00:51:53.048775
...
| --- | --- | --- |
| `AutoPlay` | `?logic` | Controls if the `particle_system_component` should play the simulation automatically when added to the scene, or when enabled from a disabled state. |
| `Enabled` | `?logic` | Controls if the `particle_system_component` should start enabled. |
...
| --- | --- |
| [`Disable`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/particle_system_component/disable) | Disables the simulation and rendering of this `particle_system`. |
| [`Enable`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/particle_system_component/enable) | Enables the simulation and rendering of this `particle_system`. |
| [`IsEnabled`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/particle_system_component/isenabled) | Succeeds if the component is enabled, fails if it’s disabled. |
...
| [`Play`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/particle_system_component/play) |  |
...
| [`Stop`](/documentation/en-us/fortnite/verse-api/versedotorg/scenegraph/particle_system_component/stop) |  |
