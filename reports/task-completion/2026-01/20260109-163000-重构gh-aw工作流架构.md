...
**思维模型** (`.github/workflows/shared/thinkModels/`):
- `skeptic.md` - 怀疑者：质疑假设，寻找反例
- `craftsman.md` - 工匠：追求精确，打磨细节
- `explorer.md` - 探险家：探索未知，尝试新路

**元认知工具** (`.github/workflows/shared/metaCognitive/`):
- `toolkit.md` - 反思、反问、假设、总结

**规范文档** (`.github/workflows/shared/`):
...
- **发生了什么**: 把 shared 放在 `.github/shared/`，但 gh-aw 期望在 `.github/workflows/shared/`
- **为什么会发生**: 没有仔细查看官方示例的目录结构，看到 `imports: shared/xxx.md` 就假设是 `.github/shared/`
- **下次如何避免**: 在创建目录结构前，先检查 gh-aw-raw 仓库的实际布局
