...
> **源文件**：`Core/skills/programming/verseDev/shared/api-digests/UnrealEngine.digest.verse.md`

### 1.2 完整模块清单交叉验证

在 Verse API 的全部 31 个模块中（覆盖 `Fortnite.com`、`Verse.org`、`UnrealEngine.com` 三个命名空间），**没有任何名为 `VerseEngine` 的模块**。

> **参考文档**：`Core/skills/programming/verseDev/shared/references/api-modules-list.md`
...
- **源文件**：`Core/skills/programming/verseDev/shared/api-digests/Verse.digest.verse.md`（第 1234-2368 行）
...
| 文档 | 路径 |
|------|------|
| Verse 核心模块 Digest | `Core/skills/programming/verseDev/shared/api-digests/Verse.digest.verse.md` |
| UnrealEngine 模块 Digest | `Core/skills/programming/verseDev/shared/api-digests/UnrealEngine.digest.verse.md` |
| 完整模块清单 | `Core/skills/programming/verseDev/shared/references/api-modules-list.md` |

### 7.2 深入学习资源

| 主题 | 推荐文档 |
|------|---------|
| SceneGraph 框架详解 | `Core/skills/programming/verseDev/shared/references/scenegraph-framework-guide.md` |
| Verse 类与对象 | `Core/skills/programming/verseDev/shared/references/verse-classes-and-objects.md` |
| Verse 失败机制 | `Core/skills/programming/verseDev/shared/references/verse-failure-mechanisms.md` |
