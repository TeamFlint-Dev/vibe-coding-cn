...
- **API Digest 文件**
  - `Core/skills/programming/verseDev/shared/api-digests/Verse.digest.verse.md` (第 1669-2030 行)

- **模块关系索引**
  - `Core/skills/programming/verseDev/shared/references/api-modules-list.md`
