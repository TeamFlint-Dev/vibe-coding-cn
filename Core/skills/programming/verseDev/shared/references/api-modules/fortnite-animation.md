...
| 文档 | 链接/路径 |
|------|----------|
| Fortnite API Digest | `Core/skills/programming/verseDev/shared/api-digests/Fortnite.digest.verse.md` (第11700-11850行) |
| Verse.org Assets 模块 | `Core/skills/programming/verseDev/shared/api-digests/Verse.digest.verse.md` |
| Animation 模块研究报告 | `Core/skills/programming/verseDev/shared/references/api-modules-research.md` |
