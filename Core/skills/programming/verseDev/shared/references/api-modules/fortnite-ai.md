...
- `Core/skills/programming/verseDev/shared/api-digests/Fortnite.digest.verse.md` - 完整 API digest
- `Core/skills/programming/verseDev/shared/references/api-modules-list.md` - 模块清单
- `Core/skills/programming/verseDev/shared/references/scenegraph-framework-guide.md` - 组件系统指南
