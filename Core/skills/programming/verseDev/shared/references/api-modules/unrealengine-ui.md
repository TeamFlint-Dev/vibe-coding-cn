...
2.**相关 API Digest 文件**- 位置：`Core/skills/programming/verseDev/shared/api-digests/UnrealEngine.digest.verse.md`
  - 包含完整的 API 定义和注释

3.**模块关系参考**- `Core/skills/programming/verseDev/shared/references/api-modules-list.md`
  - `Core/skills/programming/verseDev/shared/references/api-modules-research.md`
