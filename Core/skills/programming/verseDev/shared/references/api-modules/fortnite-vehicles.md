...
- `Core/skills/programming/verseDev/shared/api-digests/Fortnite.digest.verse.md` - 完整的 Fortnite API digest
- `Core/skills/programming/verseDev/shared/references/api-modules-list.md` - API 模块清单
- `Core/skills/programming/verseDev/shared/references/api-modules-research.md` - API 模块能力调研
