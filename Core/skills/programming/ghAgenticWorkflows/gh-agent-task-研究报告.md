...
- [gh-agent-task SKILL](../Core/skills/programming/ghAgenticWorkflows/shared/gh-aw-raw/skills/gh-agent-task/SKILL.md)
- [custom-agents SKILL](../Core/skills/programming/ghAgenticWorkflows/shared/gh-aw-raw/skills/custom-agents/SKILL.md)
- [ghAgenticWorkflows SKILL](../Core/skills/programming/ghAgenticWorkflows/SKILL.md)
