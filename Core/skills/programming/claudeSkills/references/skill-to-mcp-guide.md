...
```bash
# 基础验证
./Core/skills/programming/claudeSkills/scripts/validate-skill.sh .github/skills/<skill-name>

# 严格验证
./Core/skills/programming/claudeSkills/scripts/validate-skill.sh .github/skills/<skill-name> --strict
```
...
| 文档 | 位置 | 说明 |
|------|------|------|
| Claude Skills 元技能 | `Core/skills/programming/claudeSkills/SKILL.md` | 如何创建和重构 Skill |
| Skill 规范 | `Core/skills/programming/claudeSkills/references/skill-spec.md` | MUST/SHOULD/NEVER 规范 |
| 质量检查清单 | `Core/skills/programming/claudeSkills/references/quality-checklist.md` | 完整检查清单 |
| 反模式 | `Core/skills/programming/claudeSkills/references/anti-patterns.md` | 常见错误及修复 |
...
- 最小模板: `Core/skills/programming/claudeSkills/assets/template-minimal.md`
- 完整模板: `Core/skills/programming/claudeSkills/assets/template-complete.md`

### C. 脚本工具

```bash
# 创建新 Skill 骨架
./Core/skills/programming/claudeSkills/scripts/create-skill.sh my-skill --full --output .github/skills

# 验证 Skill
./Core/skills/programming/claudeSkills/scripts/validate-skill.sh .github/skills/my-skill --strict
```
