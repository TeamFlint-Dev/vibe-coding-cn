...
./skills/claudeSkills/scripts/validate-skill.sh skills/<skill-name>

# From repo root (strict validation)
./skills/claudeSkills/scripts/validate-skill.sh skills/<skill-name> --strict

# From skills/claudeSkills/ (basic validation)
./scripts/validate-skill.sh ../<skill-name>

# From skills/claudeSkills/ (strict validation)
...
./skills/claudeSkills/scripts/create-skill.sh my-skill --full --output skills

# From skills/claudeSkills/ (generate into ../ i.e. ./skills/)
./scripts/create-skill.sh my-skill --full --output ..

# Minimal skeleton
./skills/claudeSkills/scripts/create-skill.sh my-skill --minimal --output skills
```
...
- Sources: local spec files in `skills/claudeSkills/references/` + upstream official docs in `references/README.md`
