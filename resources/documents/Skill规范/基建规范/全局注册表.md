...
| Skill | 路径 | 标签 | 状态 |
|-------|------|------|------|
| verseDev | verseDev | verse, uefn | stable |
| verseComponent | verseDev/verseComponent | verse, component | stable |
...
### verse
- [verseDev](verseDev/SKILL.md)
- [verseComponent](verseDev/verseComponent/SKILL.md)
- ...
...
```
Core/skills/verseDev/verseComponent/SKILL.md
```
