...
GitHub Actions Workflows 技能的参考文档导航。
...
| [api-patterns.md](api-patterns.md) | GitHub API 调用模式与最佳实践 | 触发事件、获取状态 |
| [troubleshooting.md](troubleshooting.md) | 常见问题排查与解决方案 | 调试工作流问题 |
...
- **API 调用问题** → [api-patterns.md](api-patterns.md)
- **工作流失败** → [troubleshooting.md](troubleshooting.md)
