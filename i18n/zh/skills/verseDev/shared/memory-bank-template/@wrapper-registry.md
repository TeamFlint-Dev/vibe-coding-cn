...
| PetWrapper | `code-library/Wrappers/PetWrapper.verse` | Fortnite (creative_prop, positional, transform) | creative_prop, positional, transform, fort_character | REQ-PET-001 宠物/伴侣系统 | ✅ |
...
|------|---------------|----------------|------|
| 2025-12-29 | `New` | PetWrapper | 新建宠物系统 Wrapper |
