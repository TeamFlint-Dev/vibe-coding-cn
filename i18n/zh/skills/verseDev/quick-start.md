...
```
请加载 Skill: i18n/zh/skills/verse-dev/verse-orchestrator/SKILL.md
...
```
请加载以下 Skill 体系:
- 编排器: i18n/zh/skills/verse-dev/verse-orchestrator/SKILL.md
- API参考: i18n/zh/skills/verse-dev/shared/api-digests/ (Verse/Fortnite/UnrealEngine.digest.verse)
- 框架指南: i18n/zh/skills/verse-dev/shared/references/scenegraph-framework-guide.md
...
```
请加载以下 Skill:
- i18n/zh/skills/verse-dev/verse-orchestrator/SKILL.md
- i18n/zh/skills/verse-dev/verse-requirement-proposer/SKILL.md
...
```markdown
@verse-orchestrator [模式名]

示例：
@verse-orchestrator 架构设计模式
@verse-orchestrator 分层执行模式
```
...
```bash
# 1. 进入脚本目录
cd i18n/zh/skills/verseDev/verse-agent-loop/scripts
...
```
需求队列 → 编码Agent → verse-cli编译 → 评审Agents投票
    ↑                                        ↓
    └──────── 战术师更新手册 ←── 通过/升级/改进 ───┘
```
...
- **完整文档**: [verse-agent-loop/SKILL.md](verse-agent-loop/SKILL.md)
- **战术手册**: [shared/tactical-schema.md](shared/tactical-schema.md)
- **战术师**: [verse-tactician/SKILL.md](verse-tactician/SKILL.md)
