...
> **最后更新**: 2026-01-11 (Run #17)  
> **统计**: 总计 6 | 待验证 3 | 已证实 1 | 已证伪 0 | 需修正 3
...
| `needs-revision` | 3 | H001, H002, H006 |
| `confirmed` | 1 | H004 |
| `refuted` | 0 | |
| `revised` | 0 | |
| `abandoned` | 0 | |
...
- **核心**: Agent 文件封装可执行逻辑，与 patterns/ 存储问题模式不同
- **修正理由**: 双模式设计仅占 33%，不是普遍特征
- **修正方向**: 删除双模式断言，补充四种知识沉淀形式分类
...
| P1 | H006 (Agent 文件知识沉淀) | ⚠️ 需修正：删除双模式断言，补充四种形式分类 |
