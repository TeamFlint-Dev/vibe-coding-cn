...
- `skills/programming/verseDev/verseComponent/SKILL.md` - 组件开发（使用资源）
- `skills/programming/verseDev/verseEventFlow/SKILL.md` - 事件流设计（动画触发）
- `skills/programming/verseDev/verseArchitectureSelector/SKILL.md` - 架构选择（资源管理架构）
