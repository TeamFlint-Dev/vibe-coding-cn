...
- **API Digest**: `/skills/programming/verseDev/shared/api-digests/Fortnite.digest.verse.md`
  - 完整的 Fortnite API 定义文件
  - 包含所有物品类的详细定义

- **UnrealEngine Itemization API Digest**: `/skills/programming/verseDev/shared/api-digests/UnrealEngine.digest.verse.md`
  - 底层物品化系统 API 定义
