...
- **API Digest**: `skills/programming/verseDev/shared/api-digests/UnrealEngine.digest.verse.md` (行 304-327)
- **模块列表**: `skills/programming/verseDev/shared/references/api-modules-list.md`
- **能力调研**: `skills/programming/verseDev/shared/references/api-modules-research.md`
