...
- `skills/programming/verseDev/shared/references/api-modules-list.md`：API 模块完整索引
- `skills/programming/verseDev/shared/references/api-modules-research.md`：API 模块能力调研报告
- `skills/programming/verseDev/shared/references/verse-classes-and-objects.md`：Verse 类和对象系统说明
- `skills/programming/verseDev/shared/references/verse-specifiers-and-attributes.md`：Verse 修饰符和属性详解
