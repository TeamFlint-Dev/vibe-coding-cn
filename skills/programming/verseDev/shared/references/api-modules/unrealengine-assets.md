...
| UnrealEngine.com/Assets | API Digest 文件 | 本地：`skills/programming/verseDev/shared/api-digests/UnrealEngine.digest.verse.md` (行 1384-1391) |
| Verse.org/Assets | API Digest 文件 | 本地：`skills/programming/verseDev/shared/api-digests/Verse.digest.verse.md` (行 1209-1233) |
...
| 文档 | 路径 | 说明 |
|------|------|------|
| API 模块清单 | `skills/programming/verseDev/shared/references/api-modules-list.md` | 所有模块索引 |
| API 模块能力调研 | `skills/programming/verseDev/shared/references/api-modules-research.md` | 模块能力矩阵 |
| SceneGraph API 参考 | `skills/programming/verseDev/shared/references/scenegraph-api-reference.md` | SceneGraph 详细文档 |
