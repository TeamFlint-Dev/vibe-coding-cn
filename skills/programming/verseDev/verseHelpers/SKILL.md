...
> **注意**: UEFN API 封装已移至独立的 [Wrapper 层](../verseWrappers/SKILL.md)
...
> **注意**: `XXXWrapper` 类别已移至独立的 **Wrapper 层 (L1.5)**，参见 [verseWrappers](../verseWrappers/SKILL.md)
...
API 封装相关内容请参考：
- [verseWrappers SKILL](../verseWrappers/SKILL.md) - Wrapper 层定义
