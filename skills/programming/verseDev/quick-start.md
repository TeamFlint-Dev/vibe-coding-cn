...
```
请加载 Skill: skills/programming/verseDev/verseOrchestrator/SKILL.md
...
```
请加载以下 Skill 体系:
- 编排器: skills/programming/verseDev/verseOrchestrator/SKILL.md
- API参考: skills/programming/verseDev/shared/api-digests/ (Verse/Fortnite/UnrealEngine.digest.verse)
- 框架指南: skills/programming/verseDev/shared/references/scenegraph-framework-guide.md
...
- skills/programming/verseDev/verseRequirementProposer/SKILL.md
...
```bash
# 1. 进入脚本目录
cd skills/programming/verseDev/verseAgentLoop/scripts
