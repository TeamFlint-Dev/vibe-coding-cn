...
根据 [temporary-id-safe-output/SKILL.md](../../skills/programming/ghAgenticWorkflows/shared/gh-aw-raw/skills/temporary-id-safe-output/SKILL.md) 文档：
...
需要修改 gh-aw 源代码，按照 [temporary-id-safe-output/SKILL.md](../../skills/programming/ghAgenticWorkflows/shared/gh-aw-raw/skills/temporary-id-safe-output/SKILL.md) 的实现清单：
...
1. [temporary-id-safe-output/SKILL.md](../../skills/programming/ghAgenticWorkflows/shared/gh-aw-raw/skills/temporary-id-safe-output/SKILL.md) - 临时 ID 实现规范
2. [research-planner.lock.yml#L7881-7956](.github/workflows/research-planner.lock.yml#L7881-7956) - `assign_to_agent` 实现代码
3. [issue-monster.md](../../skills/programming/ghAgenticWorkflows/shared/gh-aw-raw/workflows/issue-monster.md) - `assign_to_agent` 使用示例
4. [多Job高级配置调研.md](../../skills/programming/ghAgenticWorkflows/多Job高级配置调研.md) - Agent 分配机制文档
