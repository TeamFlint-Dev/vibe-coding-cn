...
- `skills/verseDev/shared/api-digests/Fortnite.digest.verse.md` - 完整的 Fortnite API digest
- `skills/verseDev/shared/references/api-modules-list.md` - API 模块清单
- `skills/verseDev/shared/references/api-modules-research.md` - API 模块能力调研
