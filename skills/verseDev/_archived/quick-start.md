...
```
请加载 Skill: skills/verseDev/verseOrchestrator/SKILL.md
...
```
请加载以下 Skill 体系:
- 编排器: skills/verseDev/verseOrchestrator/SKILL.md
- API参考: skills/verseDev/shared/api-digests/ (Verse/Fortnite/UnrealEngine.digest.verse)
- 框架指南: skills/verseDev/shared/references/scenegraph-framework-guide.md
...
- skills/verseDev/verseRequirementProposer/SKILL.md
...
```bash
# 1. 进入脚本目录
cd skills/verseDev/verseAgentLoop/scripts
