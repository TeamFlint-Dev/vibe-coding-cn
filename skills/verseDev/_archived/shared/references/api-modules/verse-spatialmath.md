...
- **API Digest 原始文件**: `skills/verseDev/shared/api-digests/Verse.digest.verse.md`（第 2073-2332 行）
- **模块列表**: `skills/verseDev/shared/references/api-modules-list.md`
- **SceneGraph 框架**: `skills/verseDev/shared/references/scenegraph-framework-guide.md`
