...
- `skills/verseDev/shared/api-digests/Fortnite.digest.verse.md` - 完整 API digest
- `skills/verseDev/shared/references/api-modules-list.md` - 模块清单
- `skills/verseDev/shared/references/scenegraph-framework-guide.md` - 组件系统指南
